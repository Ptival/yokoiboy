...
impl DecodedInstruction {
    ...
    pub fn as_string(&self) -> String {
        match &self.instruction {
            ...
            Instruction::ADC_A_u8(u8) => format!("ADC A, {:02X}", u8),
            ...
            Instruction::CP_A_u8(u8) => format!("CP A, {:02X} (= {})", u8, u8),
            ...
            Instruction::OR_r8(r8) => format!("OR A, {}", r8),
            ...
            Instruction::SUB_A_u8(u8) => format!("SUB A, {:02X}", u8),
