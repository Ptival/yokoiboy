...
pub fn decode_instruction_at_address(
    ...
    let i = match next_u8(&mut bytes_read).0 {
        ...
        0xCB => match next_u8(&mut bytes_read).0 {
            ...
            0x2E => todo!(), // Instruction::SRA_mHL,
            0x2F => Instruction::SRA_r8(R8::A),

            0x30 => Instruction::SWAP(R8::B),
            0x31 => Instruction::SWAP(R8::C),
            0x32 => Instruction::SWAP(R8::D),
            0x33 => Instruction::SWAP(R8::E),
            0x34 => Instruction::SWAP(R8::H),
            0x35 => Instruction::SWAP(R8::L),
            0x36 => todo!(), // Instruction::SWAP_mHL,
            0x37 => Instruction::SWAP(R8::A),
